                ...
                if($sender->hasPermission("SimpleGM.use")){
                    if(isset($args[1])){
                        ...
                        if($args[0] == "0"){
                            ...
                            $sender->sendMessage("§8[§bSimple§3GM§8] §aDu hast den Gamemode von §2$change §azu §2Kreativ §ageändert!", $change);
                        } else if($args[0] == "2"){
                            $player->setGameMode(2);
                            $player->sendMessage("§8[§bSimple§3GM§8] §aDein Gamemode wurde auf §2Abendteuer §agesetzt");
                            $sender->sendMessage("§8[§bSimple§3GM§8] §aDu hast den Gamemode von §2$change §azu §2Abendteuer §ageändert!", $change);
                        } else if($args[0] == "3"){
                            $player->setGameMode(3);
                            $player->sendMessage("§8[§bSimple§3GM§8] §aDein Gamemode wurde auf §2Zuschauer §agesetzt");
                            $sender->sendMessage("§8[§bSimple§3GM§8] §aDu hast den Gamemode von §2$change §azu §2Zuschauer §ageändert!", $change);
						}
					} else {
                        if($args[0] == "0"){
